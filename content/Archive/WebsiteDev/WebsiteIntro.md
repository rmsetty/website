    ...
    <div class="tweet-header">
        ...
        <div class="user-info">
            ...
            <div class="user-icons">
                <a href="https://x.com/r_msetty/status/1866579716469293509" target="_blank">
                    <img src="https://assets1.chainstoreage.com/2023-07/twitter-x-logo.png" alt="X Icon">
                </a>
                <a href="https://www.linkedin.com/feed/update/urn:li:activity:7279415110043893760/" target="_blank">
                    <img src="https://cdn-icons-png.flaticon.com/512/174/174857.png" alt="LinkedIn Icon">
                </a>
                <a href="https://utdallas.startuptree.co/forum/2848/Portfolio-Website-for-Branding---Intro" target="_blank">
...
Considering making a static website and placing all my notes/logs on there, as it's a little confusing to find all my notes/logs here in order. <br><br> Then I can use X and StartupTree as a public outreach tool and a lead magnet for a website, which can be a lead magnet for something else.
<br>
</div>
