...
<div class="tweet-container">
    <div class="tweet-header">
        ...
        <div class="user-info">
            ...
            <div class="user-icons">
                <a href="https://lnkd.in/ec2m7NkQ" target="_blank">
    ...
    <div class="tweet-content">
        This is where I'm going to be making small software(s) with software development tools, but not AI.<br> <br>
        Most of the software I do will be inspired by tutorials on Youtube, and I'll credit the creators when needed.<br><br>
        Should be faster than usual<br>
        <hr>    
